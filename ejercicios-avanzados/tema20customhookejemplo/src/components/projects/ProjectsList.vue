...
import useSearch from '../hooks/searcher.js';
...
export default {
  ...
  setup(props) {
    console.log(props);
    const proyectos = computed(function(){
      return props.user ? props.user.projects : [];
    });
    console.log(proyectos);
    const {availableItems,enteredSearchTerm, updateSearch} = useSearch(proyectos.value,'title');
